...
Phiên bản `2026.07.16.4` bổ sung cờ thay đổi chưa đồng bộ được lưu bền trên thiết bị, cố định đơn giá theo từng buổi, chặn sửa hàng loạt các buổi đã khóa học phí, cảnh báo tác động công nợ khi xóa khoản thu, kiểm tra lịch trùng/chồng giờ và kiểm tra sâu tệp sao lưu. Lịch tương lai của học sinh đã nghỉ được giữ nguyên trong dữ liệu nhưng không xuất hiện ở màn hình vận hành.
